...
{attribname: "breast size", descs: ["","A-Cup. Tiny, fun sized mounds.","B-Cup. Small and perky.","C-Cup. Round and perky.","D-Cup. Snug and filling.","DD-Cup. Large and squishy.","E-Cup. Huge and pillowy.","F-Cup. Absolutely massive."]},
...
{attribname: "orientation", descs: ["Attracted to Women","Attracted to Men"]},
...
{attribname: "incontinence", descs: ["","You often have trouble controlling your weak bladder.","You have completely lost control over your bladder."]},
...
{attribname: "ditzy", descs: ["","You're kind of scatterbrained at times. You get distracted easily and find it hard to focus for long."]},
...
{attribname: "breast size", descs:["","Two soft, small mounds form from your chest. You've got boobs!","Your small breasts expand a little more.","Your small breasts expand a little more.","You can really feel the weight of your boobs now, as they expand.","You can really feel the weight of your boobs now, as they expand.","Your voluptuous boobs jiggle as they expand to massive proportions."]},
...
{category: "CursedTransformation", effectname: "Tasty Fluids", img:"none", desc: "<span style='color:yellow'><em>\"Don't be shy, just have a taste. Not a drop will be left to waste.\"</em></span><br/><br/><span style='float:right'>As the words form, a slight tingle runs over your body.</span><br/><br/><span style='color:lime'>(Tasty Fluids!)</span>",requiresattribnotmax:"tasty fluids"},
...
{category: "CursedTransformation", effectname: "Name Change", img:"namechange.jpg", desc: "<span style='color:yellow'><em>\"The words that others will soon repeat, a rose by any name would smell as sweet.\"</em></span><br/><br/><span style='float:right'>As the words form, the air seems to ripple for a moment.</span><br/><br/><span style='color:lime'>(Name Change!)</span>",requiresattribnotmin:"gender", requiresattribnotmax:"name change",randwt:2},
{category: "CursedTransformation", effectname: "Bad Luck", img:"none", desc: "<span style='color:yellow'><em>\"At the wrong place, at the wrong time, slip of the fingers, caught in the crime\"</em></span><br/><br/><span style='float:right'>As the words form, the air seems to ripple for a moment.</span><br/><br/><span style='color:lime'>(Bad Luck!)</span>",requiresattribnotmin:"luck"},
...
"gear":[{name:"Glyph of Protection", qty:4},{name:"Glyph of Unlocking", qty:3},{name:"Glyph of Jaunting", qty:3},{name:"Silver Coin", qty:5}],
"strength":2,
"stamina":2,
"dexterity":1,
"eyesight":1,
...
"gear":[{name:"Glyph of Protection", qty:2},{name:"Silver Coin", qty:3},{name:"Glyph of Jaunting", qty:1}],
"strength":1,
"stamina":1,
"dexterity":1,
"eyesight":1,
...
"gear":[{name:"Glyph of Unlocking", qty:2},{name:"Glyph of Protection", qty:1},{name:"Glyph of Jaunting", qty:1}],
"strength":1,
"stamina":2,
"dexterity":2,
"eyesight":1,
