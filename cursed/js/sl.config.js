...
{attribname: "increased libido", descs: ["","Your libido is higher than normal. You're going to find yourself feeling the need for release every so often.","Your libido is significantly higher than normal. You'll get hot and bothered many times a day, as you feel an almost irresistible urge for an orgasm.","Your libido is completely out of control. Your body is near-constantly horny and aching with a desperate need multiple times a day."]},
{attribname: "increased sensitivity", descs: ["","Your body is especially sensitive to touch, a careless brush across your skin sends pleasant shivers all the way down.","Your body is extremely sensitive to touch, a gentle caress would leave you squirming and panting. Moving about in tight clothing might leave you a sticky mewling mess."]},
...
{attribname: "flexible", descs: ["","Your body is very flexible and has great range of motion. All your orifices are a lot more stretchy, you'll be able to accommodate anything without much pain."]},
...
{attribname: "fluid addiction", descs: ["","You're physically addicted to cum, if you go without it, you'll crave it and feel withdrawal symptoms."]},
...
{attribname: "pierced nipples", descs: ["", "Your nipples have been pierced making them more sensitive."]},
...
{attribname: "pierced nipples", descs: ["", "As the change washes over you, you feel a stinging sensation as metal pushes through your nipples."]},
];
...
{ attribname: "pierced nipples", imgs: ["piercings.png"] },
];
...
{category: "Transformation", effectname: "Constitution Enhancement", img:"none", desc: "<span style='color:yellow'><em>\"Health is important, I'm sure you'll agree. Fit as a fiddle, you too shall be\"</em></span><br/><br/><span style='float:right'>As the words form, you feel your body being rejuvenated and revitalized.</span><br/><br/><span style='color:lime'>(Constitution Improved!)</span>", requiresattribnotmax:"constitution"},
...
{category: "CursedTransformation", effectname: "Extra Feminization", img:"physique2.jpg", desc: "<span style='color:yellow'><em>\"Get set, you're in for another round. In for a penny, in for a pound.\"</em></span><br/><br/><span style='float:right'>As the words form, you feel your body transform, your waist narrowing further as your hips widen. Your face and skin feel even softer and smoother. You let out a soft squeak, as your chest and butt feel a little tighter and fuller. </span><br/><br/><span style='color:lime'>(Extra Feminization!)</span>",requiresattribnotmin:"gender",requiresattribnotmax:"physique",randwt:4},
...
{category: "CursedTransformation", effectname: "Increased Sensitivity", img:"none", desc: "<span style='color:yellow'><em>\"A little touch will make you shiver. It's be much easier to make you quiver.\"</em></span><br/><br/><span style='float:right'>As the words form, you feel a strange tingle rush over your skin.</span><br/><br/><span style='color:lime'>(Sensitivity Increased!)</span>",requiresattribnotmin:"gender",requiresattribnotmax:"increased sensitivity",randwt:1},
...
{category: "CursedTransformation", effectname: "Pierced Nipples", img: "none", desc: "<span style='color:yellow'><em>\"It’s short-lived pain! It’s like one, two, done!\"</em></span><br/><br/><span style='float:right'>As the words form, a slight tingle runs over your body and you feel different.</span><br/><br/><span style='color:lime'>(Pierced Nipples!)</span>",requiresattribnotmin: "gender",requiresattribnotmax: "pierced nipples"},
];
