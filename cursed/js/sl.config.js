...
{category: "CursedTransformation", effectname: "Name Change", img:"namechange.jpg", desc: "<span style='color:yellow'><em>\"The words that others will soon repeat, a rose by any name would smell as sweet.\"</em></span><br/><br/><span style='float:right'>As the words form, the air seems to ripple and shift for a moment.</span><br/><br/><span style='color:lime'>(Name Change!)</span>",requiresattribnotmin:"gender", requiresattribnotmax:"name change",randwt:3},
